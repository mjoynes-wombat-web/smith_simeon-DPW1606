...
#The class which uses objects for the contacts, inherits from the data class.
class DataMultiObject(Data):
    #The initilization function.
    def __init__(self):
        #Run the init from the data class.
        Data.__init__(self)
...
#The class which uses the other classes for the contcats, inherits from the data class.
class DataMultiClass(Data):
    ...
    def __init__(self):
        ...
        #Make the contacts attribute an instance of the contact library from lib.
        self.contacts = contactLib()
        #Create a contact from the ssmithContact class.
        c1 = ssmithContact()
        #Add the contact to the contacts library using the add_contact function which comes from the contactLib class.
        self.contacts.add_contact(c1)
        #Create a contact from the jthompsonContact class.
        c2 = jthompsonContact()
        #Add the contact to the contacts library using the add_contact function which comes from the contactLib class.
        self.contacts.add_contact(c2)
        #Create a contact from the nkingContact class.
        c3 = nkingContact()
        #Add the contact to the contacts library using the add_contact function which comes from the contactLib class.
        self.contacts.add_contact(c3)
        #Create a contact from the dperkinsContact class.
        c4 = dperkinsContact()
        #Add the contact to the contacts library using the add_contact function which comes from the contactLib class.
        self.contacts.add_contact(c4)
        #Create a contact from the mjoynesContact class.
        c5 = mjoynesContact()
        #Add the contact to the contacts library using the add_contact function which comes from the contactLib class.
        self.contacts.add_contact(c5)
...
#The ssmithContact class which inherits from the Contact class.
class ssmithContact(Contact):
    #Initilization function.
    def __init__(self):
        #Run the init for the Contact class.
        Contact.__init__(self)
        #Use the add_contact method from the Contact class to populate the data.
        self.add_contact("Simeon", "Smith", 15092806173, "smsmith1@fullsail.edu", "Wombat Web Design", "Owner/Designer", "11/15/1988", "07/25/2016")
#The jthompsonContact class which inherits from the Contact class.
...
#The nkingContact class which inherits from the Contact class.
...
#The dperkinsContact class which inherits from the Contact class.
...
#The mjoynesContact class which inherits from the Contact class.
